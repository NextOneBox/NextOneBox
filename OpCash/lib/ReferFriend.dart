...
class _ReferFriendState extends State<ReferFriend> {
  ...
  var urlapp =
      'https://play.google.com/store/apps/details?id=com.earn.opcash';
  final String _content =
      '✅ Download MileCash and Earn upto daily ₹5000 use My Refferal Code =  ✅ ${account!.get(0)['Refercode']}'
      ' You can EarnUpto daily ₹5000 To ₹10000 by Completing some easy task , You Can also Earn By spin and scratch '
      'Download Now MileCash on PlayStore ';
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Color.fromARGB(255, 36, 53, 77),
                          ),
                          child: Row(children: [
                            Text(
                              'Telegram',
