...
class _SuperSpinState extends State<SuperSpin> {
  var blue = const Color.fromARGB(255, 18, 100, 167);
  final selected = BehaviorSubject<int>();
  int rewards = 0;
  final player = AudioCache();
  List items = [300, 400, 250, 350, 100, 600, 70, 230];
  ...
  void initState() {
    ...
    if (superlocked == false) {
      showNotification('✅ Unlock Spin Super Earn Daily ₹500',
          'Unlock Kro Spin Super Ko Daily ₹500 Instant withdraw kro');
    }
  }
                        ...
                        items: [
                          ...
                          FortuneItem(
                            style: FortuneItemStyle(
                                ...
                                color: Color.fromARGB(255, 212, 182, 49),
                                borderWidth: 5),
                            child: Padding(
                                padding: const EdgeInsets.only(left: 40),
                                child: Row(
  ...
  paymentkro() async {
    try {
      ...
      for (String pair in keyValuePairs) {
        ...
        if (key == "Status") {
          if (value == 'SUCCESS') {
            facebookAppEvents.logPurchase(amount: 8, currency: "INR");
            setState(() {
