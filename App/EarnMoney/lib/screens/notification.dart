...
Future getdatamessage() async {
    ...
    GetRequest(
        'https://www.nextonebox.com/earnmoney/NotGetUrls/AppUserMessages?$email', notif!);
    GetRequest(
        'https://www.nextonebox.com/earnmoney/NotGetUrls/AppGlobalMessages', globalmessage!);
            ...
            body: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (MessageList[index]['name'] == null) {
                    ...
                    listgetdate = MessageList[index]['date'].toString();
                  }
                  return Column(
                    children: [
                      Container(
