...
import '../screens/publicuserprofile.dart';
import '../screens/userdataprofile.dart';
...
Widget getProfile(img,context,name) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => publicProfileScreen(name: name, profileImg: img,)));
    },
    child: Container(
      width: 50,
      height: 60,
