      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Uri.parse(
                'https://shorts.nextonebox.com/Dashboard/'),
            body: {
            ...
            print(response.body);
                  ...
                  Text(
                    "Salvador Valverde",
                    style: TextStyle(fontSize: 15,color: c6, fontWeight: FontWeight.bold),
                  ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                                         onTap: ()async{
                              print('yes we are running');
                         var url = Uri.parse('http://127.0.0.1:3000/profile/64a527372deedc15806d2900');
                      ...
                      Column(
                        children: [
                          Text(
                            "36",
                            style: TextStyle(
                                fontSize: 20, color: c6,fontWeight: FontWeight.bold),
                          ),
                          SizedBox(
                            height: 5,
                          ),
                          Text(
                            "Following",
                            style: TextStyle(
                                fontSize: 12,color: c6, fontWeight: FontWeight.normal),
                          ),
                        ],
                      ),
                      Container(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            "Edit profile",
                            style: TextStyle(
                                fontSize: 15,color: c6, fontWeight: FontWeight.bold),
                          ),
                        ),
                      ),
                      SizedBox(
